...
class EditEventDispatcher {
    ...
    constructor(_ngZone) {
         ...
         * @return {?}
         */
        cell => closest(cell, ROW_SELECTOR))), this._startWithNull), this.focused.pipe(this._startWithNull)).pipe(map((/**
         * @param {?} __0
         * @return {?}
         */
         ...
         * @return {?}
         */
        mouseMoveRow => row === mouseMoveRow)), this._startWithNull, debounceTime(MOUSE_EVENT_DELAY_MS)))), this._startWithNullDistinct)).pipe(skip(1), // Skip the initial emission of [null, null, null, null].
