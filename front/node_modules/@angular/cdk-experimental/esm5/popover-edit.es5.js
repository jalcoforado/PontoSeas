...
var EditEventDispatcher = /** @class */ (function () {
    function EditEventDispatcher(_ngZone) {
         ...
         */
        this.editingOrFocused = combineLatest(this.editing.pipe(map((/**
         * @param {?} cell
         * @return {?}
         */
        function (cell) { return closest(cell, ROW_SELECTOR); })), this._startWithNull), this.focused.pipe(this._startWithNull)).pipe(map((/**
         * @param {?} __0
         * @return {?}
         */
        function (_a) {
         ...
         */
        this._hoveredContentStateDistinct = combineLatest(this._getFirstRowWithHoverContent(), this._getLastRowWithHoverContent(), this.editingOrFocused, this.hovering.pipe(distinctUntilChanged(), audit((/**
         * @param {?} row
         * @return {?}
         */
         ...
         * @return {?}
         */
        function (mouseMoveRow) { return row === mouseMoveRow; })), _this._startWithNull, debounceTime(MOUSE_EVENT_DELAY_MS)); })), this._startWithNullDistinct)).pipe(skip(1), // Skip the initial emission of [null, null, null, null].
