...
var EditEventDispatcher = /** @class */ (function () {
    function EditEventDispatcher(_ngZone) {
         ...
         */
        this.editingOrFocused = rxjs.combineLatest(this.editing.pipe(operators.map((/**
         * @param {?} cell
         * @return {?}
         */
        function (cell) { return closest(cell, ROW_SELECTOR); })), this._startWithNull), this.focused.pipe(this._startWithNull)).pipe(operators.map((/**
         * @param {?} __0
         * @return {?}
         */
        function (_a) {
         ...
         */
        this._hoveredContentStateDistinct = rxjs.combineLatest(this._getFirstRowWithHoverContent(), this._getLastRowWithHoverContent(), this.editingOrFocused, this.hovering.pipe(operators.distinctUntilChanged(), operators.audit((/**
         * @param {?} row
         * @return {?}
         */
         ...
         * @return {?}
         */
        function (mouseMoveRow) { return row === mouseMoveRow; })), _this._startWithNull, operators.debounceTime(MOUSE_EVENT_DELAY_MS)); })), this._startWithNullDistinct)).pipe(operators.skip(1), // Skip the initial emission of [null, null, null, null].
